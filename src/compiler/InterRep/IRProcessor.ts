...
export interface IRObject {
    /**
     * Represents the name of the compiler syntax. 
     */
    compiler: string,
    /**
     * The language that the compiler targeted
     */
    language: string,
    /**
    ...
    /**
     * Flag that specifies if the function requiere Function prototypes to compile
     */
    requieresFunctionPrototypes: boolean,
    /**
     * Flag that specifies if a variable can be interpreted as a parameter-less call (e.g. ReKarel Pascal)
     */
...
/**
 * Represents the data of a prototype
 */
type PrototypeData = { 
    argCount: number, 
    defined: boolean, 
